...
class EventType(Enum):
    ...
    PLANT_MODEL_SELECTED = "PLANT_MODEL_SELECTED"
    PLANT_CONFIGURATION_REJECTED = "PLANT_CONFIGURATION_REJECTED"
    PLANT_RESET = "PLANT_RESET"
    ENGINE_PROFILE_SELECTED = "ENGINE_PROFILE_SELECTED"
    ENGINE_PROFILE_CONFIGURATION_REJECTED = (
        "ENGINE_PROFILE_CONFIGURATION_REJECTED"
    )
